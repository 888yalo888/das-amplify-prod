...
export declare type YouthCardCheckedInOverridesProps = {
    YouthCardCheckedIn?: PrimitiveOverrideProps<FlexProps>;
...
export default function YouthCardCheckedIn(props: YouthCardCheckedInProps): React.ReactElement;
